...
def total_collection_details(request):
    ...
    comfort_advance4sub = branch53app.admin_dashboard_calculations_br53.total_collection_advance()
    ...
    comfort_advance.append(comfort_advance4sub)
    ...
    comfort_discount4sub = branch53app.admin_dashboard_calculations_br53.total_discount()
    ...
    comfort_discount.append(comfort_discount4sub)
    ...
    comfort_total_collected_amount4sub = branch53app.admin_dashboard_calculations_br53.total_collected_amount()
    ...
    comfort_due_amount4sub = branch53app.admin_dashboard_calculations_br53.total_due()
    ...
    comfort_due_amount.append(comfort_due_amount4sub)
