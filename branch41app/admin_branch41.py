...
def branch1_room_create_ob_ch41(request):
...
def branch1_room_create_regi_ob_ch41(request):
    if 'username' in request.session:
...
def view_all_room_ob_ch41(request):
    if 'username' in request.session:
...
def delete_room_ob_ch41(request,id):
    if 'username' in request.session:
...
def pg1_bed_create_ob_ch41(request):
    if 'username' in request.session:
...
def pg1_bed_create_regi_ob_ch41(request):
    if 'username' in request.session:
        if request.method == 'POST':
...
def single_pg1_bed_create_regi_ob_ch41(request):
    if 'username' in request.session:
        if request.method == 'POST':
...
def pg1_view_all_beds_ob_ch41(request):
    if 'username' in request.session:
...
def delete_bed_ob_ch41(request,id):
    if 'username' in request.session:
...
def update_bed_basic_details_ob_ch41(request,id):
    if 'username' in request.session:
        if request.method == 'POST':
            room_type = request.POST.get('roomtype')
            ...
            return pg1_view_all_beds_ob_ch41(request)
