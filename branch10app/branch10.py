...
def branch1_dashboard_ob_ch10(request):
...
def user_dashboard_calculations_ob_ch10(request):
    if 'username' in request.session:
        us = request.session['username']
        a = admin_dashboard_calculations_br10.grand_total_collection()
        from datetime import datetime
...
def admit_guest_ob_ch10(request):
    us = request.session['username']
    bgs = background_color.objects.all().filter(username=us)
    bg = background_color.objects.all().filter(username=us).exists()
    a = []
...
def br1_admit_guest_ob_ch10(request, id):
    if 'username' in request.session:
        if request.method == 'POST':
            ...
            if chk_mob == True:
                ...
                return view_all_new_guest_ob_ch10(request)
            else:
...
def view_all_new_guest_ob_ch10(request):
    if 'username' in request.session:
...
def update_br1_admit_guest_ob_ch10(request, id):
    if request.method == 'POST':
        selfmob = request.POST.get('selfmobno')
        # chk_mob = pg1_new_guest.objects.all().filter(self_mob=selfmob).exists()
        chk_mob = 10
        if chk_mob == 11:
            ...
            print('l', l)
            context = {
                'brname': 'BRANCH _ob_ch10 Room Creation Form',
                'br': pg1_new_beds.objects.all().filter(roon_no=1).order_by('roon_no'),
                'rn1': l[0]

            }
            messages.info(request, 'BRANCH_ob_ch10 guest already exists')
            # return render(request, 'branches/branch1/new_guest/view_all_new_guest.html', context)
            return view_all_new_guest_ob_ch10(request)
        else:
            name = request.POST.get('name')
            ...
            messages.info(request, 'BRANCH_ob_ch10 guest updated sucessfully')
            return view_all_new_guest_ob_ch10(request)
...
def vacate_br1_guest_ob_ch10(request, id):
    if request.method == 'POST':
        selfmob = request.POST.get('selfmobno')
        # chk_mob = pg1_new_guest.objects.all().filter(self_mob=selfmob).exists()
        chk_mob = 10
        if chk_mob == 11:
            ...
            messages.info(request, 'BRAMCH_ob_ch10 guest already exists')
            # return render(request, 'branches/branch1/new_guest/view_all_new_guest.html', context)
            return view_all_new_guest_ob_ch10(request)
        else:
            ...
            messages.info(request, 'BRANCH_ob_ch10 guest Vacated sucessfully')
            return view_all_new_guest_ob_ch10(request)
...
def active_guest_details_ob_ch10(request,guest_code):
...
def view_all_guest_ob_ch10(request):
...
def shift_guest_ob_ch10(request,id):
...
def shift_guest_regi_ob_ch10(request):
...
def unpaid_rent_choose_months_ob_ch10(request):
    if 'username' in request.session:
        us = request.session['username']
        bgs = background_color.objects.all().filter(username=us)
        bg = background_color.objects.all().filter(username=us).exists()
...
def jan_unpaid_rent_ob_ch10(request):
    if 'username' in request.session:
        us = request.session['username']
        bgs = background_color.objects.all().filter(username=us)
        bg = background_color.objects.all().filter(username=us).exists()
...
def table_jan_unpaid_rent_ob_ch10(request):
    if 'username' in request.session:
        us = request.session['username']
        bgs = background_color.objects.all().filter(username=us)
        bg = background_color.objects.all().filter(username=us).exists()
...
def feb_unpaid_rent_ob_ch10(request):
    if 'username' in request.session:
        us = request.session['username']
        bgs = background_color.objects.all().filter(username=us)
        bg = background_color.objects.all().filter(username=us).exists()
...
def table_feb_unpaid_rent_ob_ch10(request):
    if 'username' in request.session:
        us = request.session['username']
        bgs = background_color.objects.all().filter(username=us)
        bg = background_color.objects.all().filter(username=us).exists()
...
def mar_unpaid_rent_ob_ch10(request):
    if 'username' in request.session:
        us = request.session['username']
        bgs = background_color.objects.all().filter(username=us)
        bg = background_color.objects.all().filter(username=us).exists()
...
def table_mar_unpaid_rent_ob_ch10(request):
    if 'username' in request.session:
        us = request.session['username']
        bgs = background_color.objects.all().filter(username=us)
        bg = background_color.objects.all().filter(username=us).exists()
...
def april_unpaid_rent_ob_ch10(request):
    if 'username' in request.session:
        us = request.session['username']
        bgs = background_color.objects.all().filter(username=us)
        bg = background_color.objects.all().filter(username=us).exists()
...
def table_april_unpaid_rent_ob_ch10(request):
    if 'username' in request.session:
        us = request.session['username']
        bgs = background_color.objects.all().filter(username=us)
        bg = background_color.objects.all().filter(username=us).exists()
...
def may_unpaid_rent_ob_ch10(request):
    if 'username' in request.session:
        us = request.session['username']
        bgs = background_color.objects.all().filter(username=us)
        bg = background_color.objects.all().filter(username=us).exists()
...
def table_may_unpaid_rent_ob_ch10(request):
    if 'username' in request.session:
        us = request.session['username']
        bgs = background_color.objects.all().filter(username=us)
        bg = background_color.objects.all().filter(username=us).exists()
...
def june_unpaid_rent_ob_ch10(request):
    if 'username' in request.session:
        us = request.session['username']
        bgs = background_color.objects.all().filter(username=us)
        bg = background_color.objects.all().filter(username=us).exists()
...
def table_june_unpaid_rent_ob_ch10(request):
    if 'username' in request.session:
        us = request.session['username']
        bgs = background_color.objects.all().filter(username=us)
        bg = background_color.objects.all().filter(username=us).exists()
...
def july_unpaid_rent_ob_ch10(request):
    if 'username' in request.session:
        us = request.session['username']
        bgs = background_color.objects.all().filter(username=us)
        bg = background_color.objects.all().filter(username=us).exists()
...
def table_july_unpaid_rent_ob_ch10(request):
    if 'username' in request.session:
        us = request.session['username']
        bgs = background_color.objects.all().filter(username=us)
        bg = background_color.objects.all().filter(username=us).exists()
...
def aug_unpaid_rent_ob_ch10(request):
    if 'username' in request.session:
        us = request.session['username']
        bgs = background_color.objects.all().filter(username=us)
        bg = background_color.objects.all().filter(username=us).exists()
...
def table_aug_unpaid_rent_ob_ch10(request):
    if 'username' in request.session:
        us = request.session['username']
        bgs = background_color.objects.all().filter(username=us)
        bg = background_color.objects.all().filter(username=us).exists()
...
def sept_unpaid_rent_ob_ch10(request):
    if 'username' in request.session:
        us = request.session['username']
        bgs = background_color.objects.all().filter(username=us)
        bg = background_color.objects.all().filter(username=us).exists()
...
def table_sept_unpaid_rent_ob_ch10(request):
    if 'username' in request.session:
        us = request.session['username']
        bgs = background_color.objects.all().filter(username=us)
        bg = background_color.objects.all().filter(username=us).exists()
...
def oct_unpaid_rent_ob_ch10(request):
    if 'username' in request.session:
        us = request.session['username']
        bgs = background_color.objects.all().filter(username=us)
        bg = background_color.objects.all().filter(username=us).exists()
...
def table_oct_unpaid_rent_ob_ch10(request):
    if 'username' in request.session:
        us = request.session['username']
        bgs = background_color.objects.all().filter(username=us)
        bg = background_color.objects.all().filter(username=us).exists()
...
def nov_unpaid_rent_ob_ch10(request):
    if 'username' in request.session:
        us = request.session['username']
        bgs = background_color.objects.all().filter(username=us)
        bg = background_color.objects.all().filter(username=us).exists()
...
def table_nov_unpaid_rent_ob_ch10(request):
    if 'username' in request.session:
        us = request.session['username']
        bgs = background_color.objects.all().filter(username=us)
        bg = background_color.objects.all().filter(username=us).exists()
...
def dec_unpaid_rent_ob_ch10(request):
    if 'username' in request.session:
        us = request.session['username']
        bgs = background_color.objects.all().filter(username=us)
        bg = background_color.objects.all().filter(username=us).exists()
...
def table_dec_unpaid_rent_ob_ch10(request):
    if 'username' in request.session:
        us = request.session['username']
        bgs = background_color.objects.all().filter(username=us)
        bg = background_color.objects.all().filter(username=us).exists()
...
def details_of_unpaid_guests_ob_ch10(request, id):
...
def paid_rent_choose_months_ob_ch10(request):
    if 'username' in request.session:
        us = request.session['username']
        bgs = background_color.objects.all().filter(username=us)
        bg = background_color.objects.all().filter(username=us).exists()
...
def jan_paid_rent_ob_ch10(request):
    if 'username' in request.session:
        l = []
...
def table_jan_paid_rent_ob_ch10(request):
    if 'username' in request.session:
        l = []
        unp = pg1_new_guest.objects.all().filter(jan_rent_flag=200, flag=2)
        for i in unp:
...
def feb_paid_rent_ob_ch10(request):
    if 'username' in request.session:
        l = []
...
def table_feb_paid_rent_ob_ch10(request):
    if 'username' in request.session:
        l = []
        unp = pg1_new_guest.objects.all().filter(feb_rent_flag=200, flag=2)
        for i in unp:
...
def mar_paid_rent_ob_ch10(request):
    if 'username' in request.session:
        l = []
...
def table_mar_paid_rent_ob_ch10(request):
    if 'username' in request.session:
        l = []
        unp = pg1_new_guest.objects.all().filter(march_rent_flag=200, flag=2)
        for i in unp:
...
def april_paid_rent_ob_ch10(request):
    if 'username' in request.session:
        l = []
...
def table_april_paid_rent_ob_ch10(request):
    if 'username' in request.session:
        l = []
        unp = pg1_new_guest.objects.all().filter(april_rent_flag=200, flag=2)
        for i in unp:
...
def may_paid_rent_ob_ch10(request):
    if 'username' in request.session:
        l = []
...
def table_may_paid_rent_ob_ch10(request):
    if 'username' in request.session:
        l = []
        unp = pg1_new_guest.objects.all().filter(may_rent_flag=200, flag=2)
        for i in unp:
...
def june_paid_rent_ob_ch10(request):
    if 'username' in request.session:
        l = []
...
def table_june_paid_rent_ob_ch10(request):
    if 'username' in request.session:
        l = []
        unp = pg1_new_guest.objects.all().filter(june_rent_flag=200, flag=2)
        for i in unp:
...
def july_paid_rent_ob_ch10(request):
    if 'username' in request.session:
        l = []
...
def table_july_paid_rent_ob_ch10(request):
    if 'username' in request.session:
        l = []
        unp = pg1_new_guest.objects.all().filter(july_rent_flag=200, flag=2)
        for i in unp:
...
def aug_paid_rent_ob_ch10(request):
    if 'username' in request.session:
        l = []
...
def table_aug_paid_rent_ob_ch10(request):
    if 'username' in request.session:
        l = []
        unp = pg1_new_guest.objects.all().filter(auguest_rent_flag=200, flag=2)
        for i in unp:
...
def sept_paid_rent_ob_ch10(request):
    if 'username' in request.session:
        l = []
...
def table_sept_paid_rent_ob_ch10(request):
    if 'username' in request.session:
        l = []
        unp = pg1_new_guest.objects.all().filter(sept_rent_flag=200, flag=2)
        for i in unp:
...
def oct_paid_rent_ob_ch10(request):
    if 'username' in request.session:
        l = []
...
def table_oct_paid_rent_ob_ch10(request):
    if 'username' in request.session:
        l = []
        unp = pg1_new_guest.objects.all().filter(october_rent_flag=200, flag=2)
        for i in unp:
...
def nov_paid_rent_ob_ch10(request):
    if 'username' in request.session:
        l = []
...
def table_nov_paid_rent_ob_ch10(request):
    if 'username' in request.session:
        l = []
        unp = pg1_new_guest.objects.all().filter(nov_rent_flag=200, flag=2)
        for i in unp:
...
def dec_paid_rent_ob_ch10(request):
    if 'username' in request.session:
        l = []
...
def table_dec_paid_rent_ob_ch10(request):
    if 'username' in request.session:
        l = []
        unp = pg1_new_guest.objects.all().filter(dec_rent_flag=200, flag=2)
        for i in unp:
...
def details_of_paid_guests_ob_ch10(request, id):
    rno = pg1_new_guest.objects.all().filter(id=id)
    l = []
    for i in rno:
        l.append(str(i.roon_no))
...
def choose_months_ob_ch10(request):
    if 'username' in request.session:
...
def jan_manke_payments_ob_ch10(request,id):
    if 'username' in request.session:
        if request.method == 'POST':
...
def feb_manke_payments_ob_ch10(request,id):
    if 'username' in request.session:
        if request.method == 'POST':
            amt=request.POST.get('janamt')
            remark = request.POST.get('janremark')
...
def march_manke_payments_ob_ch10(request,id):
    if 'username' in request.session:
        if request.method == 'POST':
            amt=request.POST.get('janamt')
            remark = request.POST.get('janremark')
...
def april_make_payments_ob_ch10(request,id):
    if 'username' in request.session:
        if request.method == 'POST':
            amt=request.POST.get('janamt')
            remark = request.POST.get('janremark')
...
def may_make_payments_ob_ch10(request,id):
    if 'username' in request.session:
        if request.method == 'POST':
            amt=request.POST.get('janamt')
            remark = request.POST.get('janremark')
...
def june_make_payments_ob_ch10(request,id):
    if 'username' in request.session:
        if request.method == 'POST':
            amt=request.POST.get('janamt')
            remark = request.POST.get('janremark')
...
def july_make_payments_ob_ch10(request,id):
    if 'username' in request.session:
        if request.method == 'POST':
            amt=request.POST.get('janamt')
            remark = request.POST.get('janremark')
...
def aug_make_payments_ob_ch10(request,id):
    if 'username' in request.session:
        if request.method == 'POST':
            amt=request.POST.get('janamt')
            remark = request.POST.get('janremark')
...
def sept_make_payments_ob_ch10(request,id):
    if 'username' in request.session:
        if request.method == 'POST':
            amt=request.POST.get('janamt')
            remark = request.POST.get('janremark')
...
def oct_make_payments_ob_ch10(request,id):
    if 'username' in request.session:
        if request.method == 'POST':
            amt=request.POST.get('janamt')
            remark = request.POST.get('janremark')
...
def nov_make_payments_ob_ch10(request,id):
    if 'username' in request.session:
        if request.method == 'POST':
            amt=request.POST.get('janamt')
            remark = request.POST.get('janremark')
...
def dec_make_payments_ob_ch10(request,id):
    if 'username' in request.session:
        if request.method == 'POST':
            amt=request.POST.get('janamt')
            remark = request.POST.get('janremark')
...
def choose_months_advance_ob_ch10(request):
    if 'username' in request.session:
...
def jan_advance_ob_ch10(request):
    if 'username' in request.session:
        rn = request.POST.get('rno')
...
def jan_make_payments_advance_ob_ch10(request, id):
    if 'username' in request.session:
        if request.method == 'POST':
            amt = request.POST.get('janamt')
            remark = request.POST.get('janremark')
...
def feb_advance_ob_ch10(request):
    if 'username' in request.session:
        rn = request.POST.get('rno')
...
def feb_make_payments_advance_ob_ch10(request, id):
    if 'username' in request.session:
        if request.method == 'POST':
            amt = request.POST.get('janamt')
            remark = request.POST.get('janremark')
...
def march_advance_ob_ch10(request):
    if 'username' in request.session:
        rn = request.POST.get('rno')
...
def march_make_payments_advance_ob_ch10(request, id):
    if 'username' in request.session:
        if request.method == 'POST':
            amt = request.POST.get('janamt')
            remark = request.POST.get('janremark')
...
def april_advance_ob_ch10(request):
    if 'username' in request.session:
        rn = request.POST.get('rno')
...
def april_make_payments_advance_ob_ch10(request, id):
    if 'username' in request.session:
        if request.method == 'POST':
            amt = request.POST.get('janamt')
            remark = request.POST.get('janremark')
...
def may_advance_ob_ch10(request):
    if 'username' in request.session:
        rn = request.POST.get('rno')
...
def may_make_payments_advance_ob_ch10(request, id):
    if 'username' in request.session:
        if request.method == 'POST':
            amt = request.POST.get('janamt')
            remark = request.POST.get('janremark')
...
def june_advance_ob_ch10(request):
    if 'username' in request.session:
        rn = request.POST.get('rno')
...
def june_make_payments_advance_ob_ch10(request, id):
    if 'username' in request.session:
        if request.method == 'POST':
            amt = request.POST.get('janamt')
            remark = request.POST.get('janremark')
...
def july_advance_ob_ch10(request):
    if 'username' in request.session:
        rn = request.POST.get('rno')
...
def july_make_payments_advance_ob_ch10(request, id):
    if 'username' in request.session:
        if request.method == 'POST':
            amt = request.POST.get('janamt')
            remark = request.POST.get('janremark')
...
def auguest_advance_ob_ch10(request):
    if 'username' in request.session:
        rn = request.POST.get('rno')
...
def auguest_make_payments_advance_ob_ch10(request, id):
    if 'username' in request.session:
        if request.method == 'POST':
            amt = request.POST.get('janamt')
            remark = request.POST.get('janremark')
...
def sept_advance_ob_ch10(request):
    if 'username' in request.session:
        rn = request.POST.get('rno')
...
def sept_make_payments_advance_ob_ch10(request, id):
    if 'username' in request.session:
        if request.method == 'POST':
            amt = request.POST.get('janamt')
            remark = request.POST.get('janremark')
...
def october_advance_ob_ch10(request):
    if 'username' in request.session:
        rn = request.POST.get('rno')
...
def october_make_payments_advance_ob_ch10(request, id):
    if 'username' in request.session:
        if request.method == 'POST':
            amt = request.POST.get('janamt')
            remark = request.POST.get('janremark')
...
def nov_advance_ob_ch10(request):
    if 'username' in request.session:
        rn = request.POST.get('rno')
...
def nov_make_payments_advance_ob_ch10(request, id):
    if 'username' in request.session:
        if request.method == 'POST':
            amt = request.POST.get('janamt')
            remark = request.POST.get('janremark')
...
def dec_advance_ob_ch10(request):
    if 'username' in request.session:
        rn = request.POST.get('rno')
...
def dec_make_payments_advance_ob_ch10(request, id):
    if 'username' in request.session:
        if request.method == 'POST':
            amt = request.POST.get('janamt')
            remark = request.POST.get('janremark')
...
def detail_guest_general_ob_ch10(request):
    if 'username' in request.session:
        ag = pg1_new_beds.objects.all().order_by('roon_no')
        l = []
        t = []
...
def jan_close_ob_ch10(request):
    if 'username' in request.session:
        chk = branch_closing.objects.all().filter(jan='', branch_name='branch_ob_ch10').exists()
        print(chk)
        if chk == True:
            ...
            bc = branch_closing.objects.get(branch_name='branch_ob_ch10')
            bc.jan = 1
            bc.save()
            return feb_print_ob_ch10(request)

    return render(request, 'index.html')


def jan_close_decision_page_ob_ch10(request):
    if 'username' in request.session:
        chk = branch_closing.objects.all().filter(jan='', branch_name='branch_ob_ch10').exists()
        print(chk)
        if chk == True:
...
def feb_close_ob_ch10(request):
    if 'username' in request.session:
        chk = branch_closing.objects.all().filter(feb='', branch_name='branch_ob_ch10').exists()
        print(chk)
        if chk == True:
            conn = py.connect(host=database_host, user=database_user, password=database_password,
                              database=database_name)
            ...
            bc.feb = 1
            bc.save()
            return march_print_ob_ch10(request)

    return render(request, 'index.html')


def feb_close_decision_page_ob_ch10(request):
    if 'username' in request.session:
        chk = branch_closing.objects.all().filter(feb='', branch_name='branch_ob_ch10').exists()
        print(chk)
        if chk == True:
...
def march_print_ob_ch10(request):
    if 'username' in request.session:
        ag = pg1_new_beds.objects.all().order_by('roon_no')
        l = []
        t = []
...
def mar_close_ob_ch10(request):
    if 'username' in request.session:
        chk = branch_closing.objects.all().filter(mar='', branch_name='branch_ob_ch10').exists()
        ...
        if chk == True:
            ...
            bc.mar = 1
            bc.save()
            return april_print_ob_ch10(request)
    return render(request, 'index.html')


def mar_close_decision_page_ob_ch10(request):
    if 'username' in request.session:
        chk = branch_closing.objects.all().filter(mar='', branch_name='branch_ob_ch10').exists()
        print(chk)
        if chk == True:
...
def april_print_ob_ch10(request):
    if 'username' in request.session:
        ag = pg1_new_beds.objects.all().order_by('roon_no')
        l = []
        t = []
...
def apr_close_ob_ch10(request):
    if 'username' in request.session:
        chk = branch_closing.objects.all().filter(apr='', branch_name='branch_ob_ch10').exists()
        print(chk)
        if chk == True:
            conn = py.connect(host=database_host, user=database_user, password=database_password,
                              database=database_name)
            ...
            bc.apr = 1
            bc.save()
            return may_print_ob_ch10(request)
    return render(request, 'index.html')


def apr_close_decision_page_ob_ch10(request):
    if 'username' in request.session:
        chk = branch_closing.objects.all().filter(apr='', branch_name='branch_ob_ch10').exists()
        print(chk)
        if chk == True:
...
def may_close_ob_ch10(request):
    if 'username' in request.session:
        chk = branch_closing.objects.all().filter(may='', branch_name='branch_ob_ch10').exists()
        print(chk)
        if chk == True:
            conn = py.connect(host=database_host, user=database_user, password=database_password,
                              database=database_name)
            ...
            bc.may = 1
            bc.save()
            return june_print_ob_ch10(request)
    return render(request, 'index.html')


def may_close_decision_page_ob_ch10(request):
    if 'username' in request.session:
        chk = branch_closing.objects.all().filter(may='', branch_name='branch_ob_ch10').exists()
        print(chk)
        if chk == True:
...
def june_print_ob_ch10(request):
    if 'username' in request.session:
        ag = pg1_new_beds.objects.all().order_by('roon_no')
        l = []
        t = []
...
def jun_close_ob_ch10(request):
    if 'username' in request.session:
        chk = branch_closing.objects.all().filter(jun='', branch_name='branch_ob_ch10').exists()
        print(chk)
        if chk == True:
            conn = py.connect(host=database_host, user=database_user, password=database_password,
                              database=database_name)
            ...
            bc.jun = 1
            bc.save()
            return july_print_ob_ch10(request)
    return render(request, 'index.html')


def jun_close_decision_page_ob_ch10(request):
    if 'username' in request.session:
        chk = branch_closing.objects.all().filter(jun='', branch_name='branch_ob_ch10').exists()
        print(chk)
        if chk == True:
...
def july_print_ob_ch10(request):
    if 'username' in request.session:
        ag = pg1_new_beds.objects.all().order_by('roon_no')
        l = []
        t = []
...
def jul_close_ob_ch10(request):
    if 'username' in request.session:
        chk = branch_closing.objects.all().filter(jul='', branch_name='branch_ob_ch10').exists()
        print(chk)
        if chk == True:
            conn = py.connect(host=database_host, user=database_user, password=database_password,
                              database=database_name)
            ...
            bc.jul = 1
            bc.save()
            return aug_print_ob_ch10(request)
    return render(request, 'index.html')


def jul_close_decision_page_ob_ch10(request):
    if 'username' in request.session:
        chk = branch_closing.objects.all().filter(jul='', branch_name='branch_ob_ch10').exists()
        print(chk)
        if chk == True:
...
def aug_close_ob_ch10(request):
    if 'username' in request.session:
        chk = branch_closing.objects.all().filter(aug='', branch_name='branch_ob_ch10').exists()
        print(chk)
        if chk == True:
            conn = py.connect(host=database_host, user=database_user, password=database_password,
                              database=database_name)
            ...
            bc.aug = 1
            bc.save()
            return sept_print_ob_ch10(request)
    return render(request, 'index.html')


def aug_close_decision_page_ob_ch10(request):
    if 'username' in request.session:
        chk = branch_closing.objects.all().filter(aug='', branch_name='branch_ob_ch10').exists()
        print(chk)
        if chk == True:
...
def sept_print_ob_ch10(request):
    if 'username' in request.session:
        ag = pg1_new_beds.objects.all().order_by('roon_no')
        l = []
        t = []
...
def sep_close_ob_ch10(request):
    if 'username' in request.session:
        chk = branch_closing.objects.all().filter(sep='', branch_name='branch_ob_ch10').exists()
        ...
        if chk == True:
            ...
            bc.sep = 1
            bc.save()
            return oct_print_ob_ch10(request)
    return render(request, 'index.html')


def sep_close_decision_page_ob_ch10(request):
    if 'username' in request.session:
        chk = branch_closing.objects.all().filter(sep='', branch_name='branch_ob_ch10').exists()
        print(chk)
        if chk == True:
...
def oct_close_ob_ch10(request):
    if 'username' in request.session:
        chk = branch_closing.objects.all().filter(oct='', branch_name='branch_ob_ch10').exists()
        print(chk)
        if chk == True:
            conn = py.connect(host=database_host, user=database_user, password=database_password,
                              database=database_name)
            ...
            bc.oct = 1
            bc.save()
            return nov_print_ob_ch10(request)
    return render(request, 'index.html')


def oct_close_decision_page_ob_ch10(request):
    if 'username' in request.session:
        chk = branch_closing.objects.all().filter(oct='', branch_name='branch_ob_ch10').exists()
        print(chk)
        if chk == True:
...
def nov_close_ob_ch10(request):
    if 'username' in request.session:
        chk = branch_closing.objects.all().filter(nov='', branch_name='branch_ob_ch10').exists()
        print(chk)
        if chk == True:
            conn = py.connect(host=database_host, user=database_user, password=database_password,
                              database=database_name)
            ...
            bc.nov = 1
            bc.save()
            return dec_print_ob_ch10(request)
    return render(request, 'index.html')


def nov_close_decision_page_ob_ch10(request):
    if 'username' in request.session:
        chk = branch_closing.objects.all().filter(nov='', branch_name='branch_ob_ch10').exists()
        print(chk)
        if chk == True:
...
def new_year_jan_print_ob_ch10(request):
    if 'username' in request.session:
        ag = pg1_new_beds.objects.all().order_by('roon_no')
        l = []
        t = []
...
def viewall_vacate_guest_ob_ch10(request):
...
def details_of_vacate_guest_ob_ch10(request, id):
    us = request.session['username']
    bgs = background_color.objects.all().filter(username=us)
    bg = background_color.objects.all().filter(username=us).exists()
    a = []
...
def full_vacated_guest_details_ob_ch10(request):
...
def full_vacated_guest_table_ob_ch10(request):
    us = request.session['username']
    bgs = background_color.objects.all().filter(username=us)
    bg = background_color.objects.all().filter(username=us).exists()
    a = []
...
def jan_manke_payments_vacate_ob_ch10(request, id):
    if 'username' in request.session:
        if request.method == 'POST':
            amt = request.POST.get('janamt')
            remark = request.POST.get('janremark')
...
def feb_manke_payments_vacate_ob_ch10(request, id):
    if 'username' in request.session:
        if request.method == 'POST':
            amt = request.POST.get('janamt')
            remark = request.POST.get('janremark')
...
def march_manke_payments_vacate_ob_ch10(request, id):
    if 'username' in request.session:
        if request.method == 'POST':
            amt = request.POST.get('janamt')
            remark = request.POST.get('janremark')
...
def april_make_payments_vacate_ob_ch10(request, id):
    if 'username' in request.session:
        if request.method == 'POST':
            amt = request.POST.get('janamt')
            remark = request.POST.get('janremark')
...
def may_make_payments_vacate_ob_ch10(request, id):
    if 'username' in request.session:
        if request.method == 'POST':
            amt = request.POST.get('janamt')
            remark = request.POST.get('janremark')
...
def june_make_payments_vacate_ob_ch10(request, id):
    if 'username' in request.session:
        if request.method == 'POST':
            amt = request.POST.get('janamt')
            remark = request.POST.get('janremark')
...
def july_make_payments_vacate_ob_ch10(request, id):
    if 'username' in request.session:
        if request.method == 'POST':
            amt = request.POST.get('janamt')
            remark = request.POST.get('janremark')
...
def aug_make_payments_vacate_ob_ch10(request, id):
    if 'username' in request.session:
        if request.method == 'POST':
            amt = request.POST.get('janamt')
            remark = request.POST.get('janremark')
...
def sept_make_payments_vacate_ob_ch10(request, id):
    if 'username' in request.session:
        if request.method == 'POST':
            amt = request.POST.get('janamt')
            remark = request.POST.get('janremark')
...
def oct_make_payments_vacate_ob_ch10(request, id):
    if 'username' in request.session:
        if request.method == 'POST':
            amt = request.POST.get('janamt')
            remark = request.POST.get('janremark')
...
def nov_make_payments_vacate_ob_ch10(request, id):
    if 'username' in request.session:
        if request.method == 'POST':
            amt = request.POST.get('janamt')
            remark = request.POST.get('janremark')
...
def dec_make_payments_vacate_ob_ch10(request, id):
    if 'username' in request.session:
        if request.method == 'POST':
            amt = request.POST.get('janamt')
            remark = request.POST.get('janremark')
...
def view_all_due_amt_ob_ch10(request):
    us = request.session['username']
    bgs = background_color.objects.all().filter(username=us)
    bg = background_color.objects.all().filter(username=us).exists()
    a = []
...
def due_amt_mgt_choose_months_ob_ch10(request):
    us = request.session['username']
    bgs = background_color.objects.all().filter(username=us)
    bg = background_color.objects.all().filter(username=us).exists()
    a = []
...
def view_jan_account_details_ob_ch10(request):
    us = request.session['username']
    bgs = background_color.objects.all().filter(username=us)
    bg = background_color.objects.all().filter(username=us).exists()
    a = []
...
def jan_account_mgt_ob_ch10(request,id):
    if 'username' in request.session:
        if request.method == 'POST':
            ...
            ic.jan_rent_flag = chk
            ic.save()
            return view_jan_account_details_ob_ch10(request)
...
def view_feb_account_details_ob_ch10(request):
    us = request.session['username']
    bgs = background_color.objects.all().filter(username=us)
    bg = background_color.objects.all().filter(username=us).exists()
    a = []
...
def feb_account_mgt_ob_ch10(request,id):
    if 'username' in request.session:
        if request.method == 'POST':
            paid_amt = request.POST.get('pamt')
            advance = request.POST.get('adv')
            ...
            ic.feb_rent_flag = chk
            ic.save()
            return view_feb_account_details_ob_ch10(request)
...
def view_march_account_details_ob_ch10(request):
    us = request.session['username']
    bgs = background_color.objects.all().filter(username=us)
    bg = background_color.objects.all().filter(username=us).exists()
    a = []
...
def march_account_mgt_ob_ch10(request,id):
    if 'username' in request.session:
        if request.method == 'POST':
            paid_amt = request.POST.get('pamt')
            advance = request.POST.get('adv')
            ...
            ic.march_rent_flag = chk
            ic.save()
            return view_march_account_details_ob_ch10(request)
...
def view_april_account_details_ob_ch10(request):
    us = request.session['username']
    bgs = background_color.objects.all().filter(username=us)
    bg = background_color.objects.all().filter(username=us).exists()
    a = []
...
def april_account_mgt_ob_ch10(request,id):
    if 'username' in request.session:
        if request.method == 'POST':
            paid_amt = request.POST.get('pamt')
            advance = request.POST.get('adv')
            ...
            ic.april_rent_flag = chk
            ic.save()
            return view_april_account_details_ob_ch10(request)
...
def view_may_account_details_ob_ch10(request):
    us = request.session['username']
    bgs = background_color.objects.all().filter(username=us)
    bg = background_color.objects.all().filter(username=us).exists()
    a = []
...
def may_account_mgt_ob_ch10(request, id):
    if 'username' in request.session:
        if request.method == 'POST':
            paid_amt = request.POST.get('pamt')
            advance = request.POST.get('adv')
            ...
            ic.may_rent_flag = chk
            ic.save()
            return view_may_account_details_ob_ch10(request)
...
def view_june_account_details_ob_ch10(request):
    us = request.session['username']
    bgs = background_color.objects.all().filter(username=us)
    bg = background_color.objects.all().filter(username=us).exists()
    a = []
...
def june_account_mgt_ob_ch10(request,id):
    if 'username' in request.session:
        if request.method == 'POST':
            paid_amt = request.POST.get('pamt')
            advance = request.POST.get('adv')
            ...
            ic.june_rent_flag = chk
            ic.save()
            return view_june_account_details_ob_ch10(request)
...
def view_july_account_details_ob_ch10(request):
    us = request.session['username']
    bgs = background_color.objects.all().filter(username=us)
    bg = background_color.objects.all().filter(username=us).exists()
    a = []
...
def july_account_mgt_ob_ch10(request,id):
    if 'username' in request.session:
        if request.method == 'POST':
            paid_amt = request.POST.get('pamt')
            advance = request.POST.get('adv')
            ...
            ic.july_rent_flag = chk
            ic.save()
            return view_july_account_details_ob_ch10(request)
...
def view_auguest_account_details_ob_ch10(request):
    us = request.session['username']
    bgs = background_color.objects.all().filter(username=us)
    bg = background_color.objects.all().filter(username=us).exists()
    a = []
...
def auguest_account_mgt_ob_ch10(request,id):
    if 'username' in request.session:
        if request.method == 'POST':
            paid_amt = request.POST.get('pamt')
            advance = request.POST.get('adv')
            ...
            ic.auguest_rent_flag = chk
            ic.save()
            return view_auguest_account_details_ob_ch10(request)
...
def view_sept_account_details_ob_ch10(request):
    us = request.session['username']
    bgs = background_color.objects.all().filter(username=us)
    bg = background_color.objects.all().filter(username=us).exists()
    a = []
...
def sept_account_mgt_ob_ch10(request,id):
    if 'username' in request.session:
        if request.method == 'POST':
            paid_amt = request.POST.get('pamt')
            advance = request.POST.get('adv')
            ...
            ic.sept_rent_flag = chk
            ic.save()
            return view_sept_account_details_ob_ch10(request)
...
def view_october_account_details_ob_ch10(request):
    us = request.session['username']
    bgs = background_color.objects.all().filter(username=us)
    bg = background_color.objects.all().filter(username=us).exists()
    a = []
...
def october_account_mgt_ob_ch10(request,id):
    if 'username' in request.session:
        if request.method == 'POST':
            paid_amt = request.POST.get('pamt')
            advance = request.POST.get('adv')
            ...
            ic.october_rent_flag = chk
            ic.save()
            return view_october_account_details_ob_ch10(request)
...
def view_nov_account_details_ob_ch10(request):
    us = request.session['username']
    bgs = background_color.objects.all().filter(username=us)
    bg = background_color.objects.all().filter(username=us).exists()
    a = []
...
def nov_account_mgt_ob_ch10(request,id):
    if 'username' in request.session:
        if request.method == 'POST':
            paid_amt = request.POST.get('pamt')
            advance = request.POST.get('adv')
            ...
            ic.nov_rent_flag = chk
            ic.save()
            return view_nov_account_details_ob_ch10(request)
...
def view_dec_account_details_ob_ch10(request):
    us = request.session['username']
    bgs = background_color.objects.all().filter(username=us)
    bg = background_color.objects.all().filter(username=us).exists()
    a = []
...
def dec_account_mgt_ob_ch10(request,id):
    if 'username' in request.session:
        if request.method == 'POST':
            paid_amt = request.POST.get('pamt')
            advance = request.POST.get('adv')
            ...
            ic.dec_rent_flag = chk
            ic.save()
            return view_dec_account_details_ob_ch10(request)
...
def manage_bed_ob_ch10(request):
    if 'username' in request.session:
...
def manage_new_guest_ob_ch10(request):
    if 'username' in request.session:
...
def manage_update_new_guest_ob_ch10(request, id):
    if request.method == 'POST':
        selfmob = request.POST.get('selfmobno')
        # chk_mob = pg1_new_guest.objects.all().filter(self_mob=selfmob).exists()
        chk_mob = 10
        if chk_mob == 11:
            ...
            messages.info(request, 'BRANCH_ob_ch10 guest already exists')
            # return render(request, 'branches/branch1/new_guest/view_all_new_guest.html', context)
            return manage_new_guest_ob_ch10(request)
        else:
            name = request.POST.get('name')
...
def manage_update_new_guest_ob_ch10_test(request, id):
    if request.method == 'POST':
        selfmob = request.POST.get('selfmobno')
        # chk_mob = pg1_new_guest.objects.all().filter(self_mob=selfmob).exists()
        chk_mob = 10
...
def manage_update_beds_ob_ch10(request, id):
    if request.method == 'POST':
        selfmob = request.POST.get('selfmobno')
        # chk_mob = pg1_new_guest.objects.all().filter(self_mob=selfmob).exists()
        chk_mob = 10
        if chk_mob == 11:
            ...
            messages.info(request, 'BRANCH_ob_ch10 guest updated sucessfully')
            return manage_bed_ob_ch10(request)
...
def pysql(request):
    ...
    return branch1_dashboard_ob_ch10 (request)
...
def dynamic(request):
    if 'username' in request.session:
        ...
        context = {
            ...
            'mt2':'page five _ob_ch10 dynamic code',
...
def background_ob_ch10(request):
    if 'username' in request.session:
        us = request.session['username']
        bgs = background_color.objects.all().filter(username=us)
        bg = background_color.objects.all().filter(username=us).exists()
...
def background_regi_ob_ch10(request):
    if 'username' in request.session:
        us = request.session['username']
...
def custom_background_regi_ob_ch10(request):
    if 'username' in request.session:
        us = request.session['username']
        th = request.POST.get('theme')
        uc=background_color.objects.all().filter(username=us).exists()
...
def update_all_rent_ob_ch10(request):
    z=10
    if z==10:
        r=6000
        l=[]
