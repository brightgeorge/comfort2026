...
from branch26app.models import table1,in_exp_items_daily,opening_balance,category,ledger,accounts_book,background_color,share_holders
...
def view_all_category26(request):
    if 'username' in request.session:
        ...
        return render(request,'branches/branch26/accounts/creater_master/category/view_all_category.html',context)
    return render(request, 'index.html')

def create_new_category26(request):
    if 'username' in request.session:
        ...
        return render(request,'branches/branch26/accounts/creater_master/category/create_new_category.html',context)
    return render(request, 'index.html')

def regi_new_category26(request):
    if 'username' in request.session:
        ...
        if ir == True:
            ...
            return render(request, 'branches/branch26/accounts/creater_master/items/view_all_items.html', context)
        else:
...
def regi_multiple_new_category26(request):
    if 'username' in request.session:
        category_names = request.POST.get('category')
        ir = category.objects.all().filter(category_name=category_names,flag=1).exists()
...
def update_category26(request,id):
    if 'username' in request.session:
        ...
        return render(request,'branches/branch26/accounts/creater_master/category/update_category.html',context)
    return render(request, 'index.html')


def delete_category26(request,id):
    if 'username' in request.session:
...
def view_all_category_delete26(request):
    if 'username' in request.session:
        ...
        return render(request,'branches/branch26/accounts/creater_master/category/view_all_category_delete.html',context)
    return render(request, 'index.html')
...
def create_new_item26(request):
    if 'username' in request.session:
        ...
        return render(request,'branches/branch26/accounts/creater_master/items/create_new_item.html',context)
    return render(request, 'index.html')

def regi_new_item26(request):
    if 'username' in request.session:
...
def regi_multiple_new_item26(request):
    if 'username' in request.session:
        item_name = request.POST.get('name')
        item_category = request.POST.get('category')
        ir = table1.objects.all().filter(name=item_name, flag=1).exists()
...
def update_item26(request,id):
    if 'username' in request.session:
        ...
        return render(request,'branches/branch26/accounts/creater_master/items/update_item.html',context)
    return render(request, 'index.html')

def view_all_items_delete26(request):
    if 'username' in request.session:
        ...
        return render(request,'branches/branch26/accounts/creater_master/items/view_all_items_delete.html',context)
    return render(request, 'index.html')
...
def view_all_ledger26(request):
    if 'username' in request.session:
        ...
        return render(request,'branches/branch26/accounts/creater_master/ledger/view_all_ledger.html',context)
    return render(request, 'index.html')

def create_new_ledger26(request):
    if 'username' in request.session:
        ...
        return render(request,'branches/branch26/accounts/creater_master/ledger/create_new_ledger.html',context)
    return render(request, 'index.html')

def regi_new_ledger26(request):
    if 'username' in request.session:
...
def regi_multiple_new_ledger26(request):
    if 'username' in request.session:
        ledger_name = request.POST.get('ledger_name')
        contact_person_name = request.POST.get('contact_person_name')
        contact_person_number = request.POST.get('contact_person_number')
...
def delete_ledger26(request,id):
    if 'username' in request.session:
...
def update_ledger26(request,id):
    if 'username' in request.session:
        if request.method == 'POST':
            ledger_name = request.POST.get('ledger_name')
            contact_person_name = request.POST.get('contact_person_name')
        ...
        return render(request,'branches/branch26/accounts/creater_master/ledger/update_ledger.html',context)
    return render(request, 'index.html')

def view_all_ledger_delete26(request):
    if 'username' in request.session:
        ...
        return render(request,'branches/branch26/accounts/creater_master/ledger/view_all_ledger_delete.html',context)
    return render(request, 'index.html')
...
def view_all_accounts_book26(request):
    if 'username' in request.session:
        ...
        return render(request,'branches/branch26/accounts/creater_master/accounts_book/view_all_accounts_book.html',context)
    return render(request, 'index.html')

def create_new_accounts_book26(request):
    if 'username' in request.session:
        ...
        return render(request,'branches/branch26/accounts/creater_master/accounts_book/create_new_accounts_book.html',context)
    return render(request, 'index.html')

def regi_new_accounts_book26(request):
    if 'username' in request.session:
...
def regi_multiple_new_accounts_book26(request):
    if 'username' in request.session:
        accounts_book_name = request.POST.get('accounts_book_name')
...
def delete_accounts_book26(request,id):
    if 'username' in request.session:
...
def update_accounts_book26(request,id):
    if 'username' in request.session:
        if request.method == 'POST':
            accounts_book_name = request.POST.get('accounts_book_name')
        ...
        return render(request,'branches/branch26/accounts/creater_master/accounts_book/update_accounts_book.html',context)
    return render(request, 'index.html')

def view_all_accounts_book_delete26(request):
    if 'username' in request.session:
        ...
        return render(request,'branches/branch26/accounts/creater_master/accounts_book/view_all_accounts_book_delete.html',context)
    return render(request, 'index.html')
...
def in_exp_items_entry26(request):
    if 'username' in request.session:
        ...
        print(context)
        return render(request,'branches/branch26/accounts/journal/in_exp_items_entry.html',context)
    return render(request, 'index.html')



def reg_in_exp_items_entry26(request):
    if 'username' in request.session:
...
def delete_journal26(request,id):
    if 'username' in request.session:
...
def update_in_exp_items_entry26(request,id):
    if 'username' in request.session:
        ...
        return render(request, 'branches/branch26/accounts/journal/update_in_exp_items_entry.html', context)
    return render(request, 'index.html')

def detailed_journal_report26(request):
    if 'username' in request.session:
        ...
        return render(request, 'branches/branch26/accounts/journal/detailed_journal_report.html', context)
    return render(request, 'index.html')

def journal_report_deleted26(request):
    if 'username' in request.session:
        ...
        return render(request, 'branches/branch26/accounts/journal/journal_report_deleted.html', context)
    return render(request, 'index.html')
...
def daily_category_wise26(request):
    if 'username' in request.session:
        ...
        return render(request,'branches/branch26/accounts/accounts_reports/category/daily_category_wise.html',context)
    return render(request, 'index.html')


def monthly_category_based_reports26(request):
    if 'username' in request.session:
        ...
        return render(request,'branches/branch26/accounts/accounts_reports/category/monthly_category_based_reports.html',context)
    return render(request, 'index.html')


def yearly_category_based_reports26(request):
    if 'username' in request.session:
        ...
        return render(request,'branches/branch26/accounts/accounts_reports/category/yearly_category_based_reports.html',context)
    return render(request, 'index.html')
...
def daily_detailed26(request):
    if 'username' in request.session:
        ...
        return render(request,'branches/branch26/accounts/accounts_reports/detailed/daily_detailed.html',context)
    return render(request, 'index.html')


def monthly_detailed26(request):
    if 'username' in request.session:
        ...
        return render(request,'branches/branch26/accounts/accounts_reports/detailed/monthly_detailed.html',context)
    return render(request, 'index.html')


def yearly_detailed26(request):
    if 'username' in request.session:
        ...
        return render(request,'branches/branch26/accounts/accounts_reports/detailed/yearly_detailed.html',context)
    return render(request, 'index.html')
...
def item_based_reports26(request):
    if 'username' in request.session:
        ...
        return render(request,'branches/branch26/accounts/accounts_reports/item/item_based_reports.html',context)
    return render(request, 'index.html')



def daily_item_based_reports26(request):
    if 'username' in request.session:
        ...
        return render(request,'branches/branch26/accounts/accounts_reports/item/daily_item_based_reports.html',context)
    return render(request, 'index.html')



def monthly_item_based_reports26(request):
    if 'username' in request.session:
        ...
        return render(request,'branches/branch26/accounts/accounts_reports/item/monthly_item_based_reports.html',context)
    return render(request, 'index.html')
...
def daily_ledger_based_reports26(request):
    if 'username' in request.session:
        ...
        return render(request,'branches/branch26/accounts/accounts_reports/ledger/daily_ledger_based_reports.html',context)
    return render(request, 'index.html')


def ledger_based_reports26(request):
    if 'username' in request.session:
        ...
        return render(request,'branches/branch26/accounts/accounts_reports/ledger/ledger_based_reports.html',context)
    return render(request, 'index.html')



def monthly_ledger_based_reports26(request):
    if 'username' in request.session:
        ...
        return render(request,'branches/branch26/accounts/accounts_reports/ledger/monthly_ledger_based_reports.html',context)
    return render(request, 'index.html')
...
def accounts_book_based_reports26(request):
    if 'username' in request.session:
        ...
        return render(request,'branches/branch26/accounts/accounts_reports/accounts_book/accounts_book_name_based_reports.html',context)
    return render(request, 'index.html')



def daily_accounts_book_based_reports26(request):
    if 'username' in request.session:
        ...
        return render(request,'branches/branch26/accounts/accounts_reports/accounts_book/daily_accounts_book_based_reports.html',context)
    return render(request, 'index.html')



def monthly_accounts_book_based_reports26(request):
    if 'username' in request.session:
        ...
        return render(request,'branches/branch26/accounts/accounts_reports/accounts_book/monthly_accounts_book_based_reports.html',context)
    return render(request, 'index.html')
...
def monthly_reports_choose_months26(request):
    if 'username' in request.session:
        ...
        return render(request,'branches/branch26/accounts/monthly_reports/monthly_reports_choose_months.html',context)
    return render(request, 'index.html')



def monthly_detailed_daily_in_exp_items_report26(request,mo):
    if 'username' in request.session:
    ...
    ##****************************************
        ...
        return render(request,'branches/branch26/accounts/monthly_reports/monthly_detailed_daily_in_exp_items_report.html',context)
    return render(request, 'index.html')
...
def single_monthly_reports_choose_months26(request):
    if 'username' in request.session:
        ...
        return render(request,'branches/branch26/accounts/monthly_reports/single_monthly_reports_choose_months.html',context)
    return render(request, 'index.html')

def single_monthly_daily_in_exp_items_report26(request,mo):
    if 'username' in request.session:
        ...
        for i in expense_26:
            l_expense_26.append(float(i.amount))
        r_expense_26 = sum(l_expense_26)
        r_balance_26 = r_balance_23 + r_income_26 - r_expense_26
        ...
        for i in expense_26:
            l_expense_26.append(float(i.amount))
        r_expense_26 = sum(l_expense_26)
        r_balance_26 = r_balance_26 + r_income_26 - r_expense_26
        ...
        return render(request,'branches/branch26/accounts/monthly_reports/single_monthly_daily_in_exp_items_report.html',context)
    return render(request, 'index.html')
...
def accounts_dash_board_ob_ch26(request):
    if 'username' in request.session:
        ...
        return render(request,'branches/branch26/accounts/accounts_dash_board.html',context)
    return render(request, 'index.html')
...
def accounts_dash_board26(request):
    if 'username' in request.session:
...
def profit_sharing_choose_months26(request):
    if 'username' in request.session:
        us = request.session['username']
        bgs = background_color.objects.all().filter(username=us)
        bg = background_color.objects.all().filter(username=us).exists()
        ...
        return render(request,'branches/branch26/accounts/profit_sharing/profit_sharing_choose_months.html',context)

def profit_sharing26(request,mo):
    if 'username' in request.session:
        ...
        return render(request,'branches/branch26/accounts/profit_sharing/profit_sharing.html',context)
    return render(request, 'index.html')

def view_share_holders26(request):
    if 'username' in request.session:
        us = request.session['username']
        bgs = background_color.objects.all().filter(username=us)
        bg = background_color.objects.all().filter(username=us).exists()
        ...
        return render(request, 'branches/branch26/accounts/profit_sharing/view_share_holders.html',context)

def create_share_holders26(request):
    if 'username' in request.session:
        us = request.session['username']
        bgs = background_color.objects.all().filter(username=us)
        bg = background_color.objects.all().filter(username=us).exists()
        ...
        return render(request, 'branches/branch26/accounts/profit_sharing/create_share_holders.html',context)


def regi_share_holders26(request):
    if 'username' in request.session:
        ...
        if tsa <101:
            ...
            return view_share_holders26(request)
...
def regi_multiple_share_holders26(request):
    if 'username' in request.session:
        a=share_holders.objects.all().filter(flag=1)
        tsp=[]
        for i in a:
...
def update_share_holders26(request,id):
    if 'username' in request.session:
        if request.method == 'POST':
            name = request.POST.get('name')
            share = request.POST.get('share')
        ...
        return render(request, 'branches/branch26/accounts/profit_sharing/update_share_holders.html',context)

def delete_share_holders26(request,id):
    if 'username' in request.session:
...
def view_deleted_share_holders26(request):
    if 'username' in request.session:
        us = request.session['username']
        bgs = background_color.objects.all().filter(username=us)
        bg = background_color.objects.all().filter(username=us).exists()
        ...
        return render(request, 'branches/branch26/accounts/profit_sharing/view_deleted_share_holders.html',context)
